...
class essential_admin_setting_styleguide extends admin_setting {
    ...
    public function output_html($data, $query = '') {
        ...
        $return .= "}";
        $return .= "/* Chevrons */";
        $return .= ".bs-docs-sidenav .icon-chevron-right {";
        $return .= "float: right;";
        ...
        $return .= "background-color: #f5f5f5;";
        $return .= "}";
        $return .= ".bs-docs-sidenav a:hover .icon-chevron-right {";
        $return .= "opacity: .5;";
        $return .= "}";
        $return .= ".bs-docs-sidenav .active .icon-chevron-right,";
        $return .= ".bs-docs-sidenav .active a:hover .icon-chevron-right {";
