...
class essential_admin_setting_styleguide extends admin_setting {
    ...
    public function output_html($data, $query = '') {
        ...
        $return .= '<input type="text" class="search-query span2" placeholder="Search">';
        $return .= '</form>';
        ...
        $return .= '<li class="span4">';
        $return .= '<a href="#" class="thumbnail">';
        $return .= '<img data-src="holder.js/360x270" alt="">';
        $return .= '</a>';
        $return .= '</li>';
        $return .= '<li class="span3">';
        $return .= '<a href="#" class="thumbnail">';
        $return .= '<img data-src="holder.js/260x120" alt="">';
        $return .= '</a>';
        $return .= '</li>';
        $return .= '<li class="span2">';
        $return .= '<a href="#" class="thumbnail">';
        $return .= '<img data-src="holder.js/160x120" alt="">';
        $return .= '</a>';
        $return .= '</li>';
        $return .= '<li class="span3">';
        $return .= '<a href="#" class="thumbnail">';
        ...
        $return .= '<img class="media-object" data-src="holder.js/64x64">';
        $return .= '</a>';
        ...
        $return .= '<td>boolean</td>';
        $return .= '<td>false</td>';
        $return .= '<td>Insert html into the popover. If false, jquery\'s <code>text</code> method will be used to insert ';
        $return .= 'content into the dom. Use text if you\'re worried about XSS attacks.</td>';
        $return .= '</tr>';
        $return .= '<tr>';
        $return .= '<td>placement</td>';
